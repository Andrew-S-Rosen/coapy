...
- Added option to format as NSF COA or DOE collaborator list

### Fixed

- Fixed parsing of OpenAlex data where ChemRxiv preprints would result in the wrong author list and years being returned
